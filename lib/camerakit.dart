...
class Camkit extends StatefulWidget {
  @override
  _CamkitState createState() => _CamkitState();
}

class _CamkitState extends State<Camkit> {
  String _platformVersion = 'Unknown';
  late CameraKitView cameraKitView;
  CameraFlashMode _flashMode = CameraFlashMode.on;
  late CameraKitController cameraKitController;
